...
protocol VastTrackerNonLinearDelegate: AnyObject {
    func adBreakStart(vastTracker: VastTrackerNonLinear)
    func adBreakComplete(vastTracker: VastTrackerNonLinear)
}

class VastTrackerNonLinear {
    weak var delegate: VastTrackerNonLinearDelegate?
    ...
    init(id: String, vastModel: VastModel, startTime: Double = 0.0, supportAdBuffets: Bool = false, delegate: VastTrackerNonLinearDelegate? = nil, trackProgressCumulatively: Bool = true) {
        self.id = id
    ...
    convenience init(id: String, vmapModel: VMAPModel, breakId: String, startTime: Double, supportAdBuffets: Bool = false, delegate: VastTrackerNonLinearDelegate? = nil) throws {
